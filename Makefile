...
docker-demo-regtest:
	...
	cd docker && docker-compose up --build --force-recreate --abort-on-container-exit
...
docker-rust-2-chains:
	cd docker/rustdemo-2-chains && docker-compose up --build --force-recreate --abort-on-container-exit
