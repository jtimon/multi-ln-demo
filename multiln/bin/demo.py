...
ln_sync_blockheight(BITCOIND, LIGHTNINGD, timeout=60, interval=5, label='initial funds on lightningd nodes')
...
ln_sync_blockheight(BITCOIND, LIGHTNINGD, timeout=60, interval=5, label='channels to be confirmed')
